...
export default function HostBloodDrive() {
        ...
        <>
            ...
            <section style={containerStyle} className="h-screen flex justify-center items-center">
                <div style={formContainerStyle}>
                    <div className="py-3">
                        <p className="text-center text-white fst-italic fs-2 fw-bolder">HOST A BLOOD DRIVE</p>
                    </div>
                    {showForm ? (
                        <>
                            <div className="row p-4">
                                ...
                                <div className="col-md-6 py-2">
                                    <InputComponent
                                        value={model.userName}
                                        onchange={(e) => (
                                            fillModel("Institute", e.target.value)
                                        )
                                        }
                                        label="Institute"
                                    />
                                ...
                                <div className="col-md-6 py-2">
                                    <InputComponent
                                        value={model.userName}
                                        onchange={(e) => (
                                            fillModel("Designation", e.target.value)
                                        )
                                        }
                                        label="Designation"
                                    />
