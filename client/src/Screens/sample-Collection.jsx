...
import bgImg from '../Images/Carousel-Img-3.jpg'
        ...
        <>
            ...
            <section style={containerStyle} className="h-screen flex justify-center items-center">
                <div style={formContainerStyle}>
                    <div className="py-3">
                        <p className="text-center text-white fst-italic fs-2 fw-bolder">GET TEST SAMPLES</p>
                    </div>
                    {showForm ? (
                        <>
                            <div className="row p-4">
                                ...
                                <div className="col-md-6 py-2">
                                    <InputComponent
                                        value={model.userName}
                                        onchange={(e) => (
                                            fillModel("TypeofTest", e.target.value)
                                        )
                                        }
                                        label="Type of Test (Optional)"
                                    />
                                </div>
